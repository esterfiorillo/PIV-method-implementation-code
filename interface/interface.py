...
"""
Initialization of the lists that will store the displacement vector maps of each method.
"""
dpx_list1 = []
dpy_list1 = []
dpx_list2 = []
...
class mywindow(QtWidgets.QMainWindow):
    ...
    Ui_MainWindow: QtWidgets.QMainWindow
        Class generated by the interface .ui file, made in the QtDesigner program
