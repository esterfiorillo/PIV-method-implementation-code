...
#------------------------------------------------------------------------------
"""
This file represents the class that assigns functions to the interface generated in Qt Designer
"""
...
class mywindow(QtWidgets.QMainWindow):
    """
    Class that will represent the graphical interface.
    """
    ...
    def quit_interface(self):
        """
        Function that closes the interface. It is called when the quitt button is pressed.
        """
        sys.exit(0)
    ...
    def select_images1(self):
        """
        Function that takes the address string from the first image file. It is called when the 3-point button is pressed.
        """
    ...
    def populate_im_lines(self):
        """   
        Function that takes the values entered by the user for number of images, size of the interrogation window, overlap, method used and the number of iterations if the multigrid method is chosen.
        This function is called when the ok button is pressed, indicating that the user has finished choosing the parameters.
        """
